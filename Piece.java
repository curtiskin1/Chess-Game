// Edited by Curtis Kokuloku (kokul003) on 09/24/22
...
public class Piece {
    ...
    public void setPosition(int row, int col) {
        ...
        if (!this.isBlack && row == 0 && this.getCharacter() == '\u2659') {
            boolean isValid = false;
            while (!isValid) {
                System.out.println("Choose character you want to promote to:\n Choose \"Q\" for Queen, \"K\" for Knight, \"B\" for Bishop, or \"R\" for Rook");
        ...
        } else if (this.isBlack && row == 7 && this.getCharacter() == '\u265f') {
            boolean isValid = false;
            while (!isValid) {
                System.out.println("Choose character you want to promote to:\n Choose \"Q\" for Queen, \"K\" for Knight, \"B\" for Bishop, or \"R\" for Rook");
                Scanner myScanner = new Scanner(System.in);
